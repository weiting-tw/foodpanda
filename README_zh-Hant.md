...
3. 如果是使用帳號/密碼登入，x-device & x-device-fingerprint 欄位是必要的。你可以依照 [obtain_token](https://github.com/tsunglung/foodpanda/blob/master/docs/obtain_token.md#obtain-x-device) 取得 x-device & x-device-fingerprint 的值
